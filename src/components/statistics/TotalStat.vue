<template>
  <div class="section__statistics">
    ...
    <div class="section__statistics__date" style="margin-bottom: 20px">
    ...
    <div class="section__row">
      <div class="section__statistics__item">
        <div
          class="section__statistics__item__img"
          style="background: linear-gradient(#3e3d45, #202020)"
        >
          <v-icon class="mdi">mdi-account-cash-outline</v-icon>
        </div>
        <div class="section__statistics__item__header">
      ...
      <div class="section__statistics__item">
        <div
          class="section__statistics__item__img"
          style="background: linear-gradient(#e93b77, #da1f63)"
        >
          <v-icon class="mdi">mdi mdi-table-check</v-icon>
        </div>
        <div class="section__statistics__item__header">
      ...
      <div class="section__statistics__item">
        <div
          class="section__statistics__item__img"
          style="background: linear-gradient(#63b9a6, #4ba64f)"
        >
          <v-icon class="mdi">mdi-order-bool-ascending-variant</v-icon>
        </div>
        <div class="section__statistics__item__header">
      ...
      <div class="section__statistics__item">
        <div
          class="section__statistics__item__img"
          style="background: linear-gradient(#439dee, #1e78e9)"
        >
          <v-icon class="mdi">mdi-account-multiple-plus</v-icon>
        </div>
        <div class="section__statistics__item__header">
